...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "EdCntApplAttr")) { 

		$updateSQL = sprintf("UPDATE ".TB_CNT_APPL_ATTR." SET cntapplattr_vl=%s WHERE cntapplattr_enc=%s",
						   GtSQLVlStr(ctjTx($_POST['cntapplattr_vl'],'out'), "text"),	
	                       GtSQLVlStr($_POST['cntapplattr_enc'], "text"));
