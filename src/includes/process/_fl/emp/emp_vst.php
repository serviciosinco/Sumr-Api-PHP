...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "EdConCrrVst")) {
	...
	$insertSQL = sprintf("INSERT INTO ".MDL_EMP_VST_BD." ( id_empvst, empvst_sistp, empvst_us, empvst_cnt, empvst_va, empvst_tp, empvst_f, empvst_h, empvst_fr, empvst_hr, empvst_pln, empvst_rxc, empvst_rxc_est, empvst_grn, empvst_dir, empvst_obs, empvst_rsl, empvst_aplz, empvst_est, empvst_ofr, empvst_fi, empvst_fa) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
					GtSQLVlStr($_POST['id_empvst'], "int"),
	...
	if($Result){
		...
		$updateSQL = sprintf("UPDATE ".MDL_EMP_VST_BD." SET empvst_enc=%s WHERE id_empvst=%s",
						GtSQLVlStr(enCad($rsp['i']), "text"),
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "EdConCrrVst")) { 
	...
	$updateSQL = sprintf("UPDATE ".MDL_EMP_VST_BD." SET empvst_sistp=%s, empvst_us=%s, empvst_cnt=%s, empvst_va=%s, empvst_tp=%s, empvst_f=%s, empvst_h=%s, empvst_fr=%s, empvst_hr=%s, empvst_pln=%s, empvst_rxc=%s, empvst_rxc_est=%s, empvst_grn=%s, empvst_dir=%s, empvst_obs=%s, empvst_rsl=%s, empvst_aplz=%s, empvst_tra=%s, empvst_est=%s, empvst_ofr=%s, empvst_fi=%s, empvst_fa=%s WHERE empvst_enc=%s",
		               ...
		               GtSQLVlStr( Html_chck_vl($_POST['empvst_tra']) , "int"),	
		               GtSQLVlStr($_POST['empvst_est'], "int"),
		               GtSQLVlStr( Html_chck_vl($_POST['empvst_ofr']) , "int"),
		               GtSQLVlStr($_POST['empvst_fi'], "date"),
					   GtSQLVlStr($_POST['empvst_fa'], "date"),
					   GtSQLVlStr($_POST['empvst_enc'], "int"));
