								...
								if($TotEcCmpgEst > 0){
									...
									do{
										...
										//----------- GET CAMPAIGN DETAIL -----------//
											...
											echo $this->h2('Process Campaign '.$this->Spn($rwEcCmpgEst['id_eccmpg']) );
										...
										//----------- IT IS ALLOWED FOR DATE ? -----------//
											...
											echo $this->li('Allowed by date? '.$this->Spn($_cmpg_dt->allw) );
											...
											echo $this->li('Allowed to change ready? ');
											echo $this->li( 'Allow: '.$_cmpg_dt->eml_allw);
											echo $this->li( 'Queue: '.$_cmpg_dt->btch->in);
											echo $this->li( 'Estatus: '.$_cmpg_dt->est->id.' ('.$_cmpg_dt->est->nm.')');
											//echo $this->li( 'Diff: '.compress_code( print_r($_cmpg_dt->tme->diff, true) ));
