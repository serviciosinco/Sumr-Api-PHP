						...
						if($Tot_BncChk > 0){
							...
							do{
								...
								if($___prc->e == 'ok'){
									...
									echo $this->scss("Marcado como bloqueado <span style='color:orange;'>".$row_BncChk['cnteml_eml']."</span> con estado "._CId('ID_CLD_BAD'). print_r($___prc, true)); 
										
								}else{
									
									echo $this->err("No hay respuesta: ".print_r($_chk_eml, true).$___prc->w);
