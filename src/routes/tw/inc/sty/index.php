<?php include('inc/_inc.php'); ob_start("compress_code");
...
<link href="inc/sty/all.css?_h=<?php echo $_hshtg_tx ?>" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div class="__wrp_center">
        ...
        <script type="text/javascript" src="inc/js/myj.js?_h=<?php echo $_hshtg_tx ?>"></script>
