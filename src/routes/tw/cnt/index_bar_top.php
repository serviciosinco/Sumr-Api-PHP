...
<link href="inc/sty/all.css?_h=<?php echo $_hshtg_tx ?>&_t=bar_top" rel="stylesheet" type="text/css">
    ...
    <div class="__wrp_center">
            <header style="background-color:#<?php echo $_hshtg_tx_svclr ?>" class="_hdr" id="_Hdr" >
                        ...
                        <div id="_ImgHdr">
                            ...
                            <?php */ ?>
                            <?php $_fhdr = '_h'; include('cnt/dt/swf.php'); ?>
                        </div>
          </header> 
          <div class="container">
		...
		<script type="text/javascript" src="inc/js/myj.js?_h=<?php echo $_hshtg_tx ?>&max=1&prfl_big=ok"></script>
        <script type="text/javascript" src="inc/js/js2.js?_h=<?php echo $_hshtg_tx ?>&max=1&prfl_big=ok"></script>
