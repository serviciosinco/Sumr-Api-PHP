<?php 
    ...
    $LsQry = "  SELECT
                    orgsdsarrsls_vl, orgsdsarrsls_f, orgsdsarr_orgsds, org_nm 
                ...
                WHERE
                    id_orgsdsarrsls != '' AND orgsdsarr_vl_mnt = 2
    ...
    if($LsRg){ 
        ...
        if($TotLsRg > 0){
            ...
            do {
					...
					$Vl['d'][$rwLsRg['orgsdsarr_orgsds']]['f'][$rwLsRg['orgsdsarrsls_f']]['tot'] = $rwLsRg['orgsdsarrsls_vl'];
           
            } while ($rwLsRg = $LsRg->fetch_assoc());

            $Vl_Grph = _jEnc($Vl);

            echo bdiv([ 'id'=>'bx_grph_7_marks', 'sty'=>'height:300px; max-height:300px;' ]);
