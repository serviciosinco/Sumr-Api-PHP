...
<div class="ln_1">
    ...
    <div class="col_1 __rlc_e on" id="<?php echo $__id_div_act ?>">
            ...
            <?php echo $__li_act['tt'].ul('<div class="__ovly_w"></div>', '_cl_prm'); ?>
             
    </div>
    <div class="col_2 __rlc_e off" id="<?php echo $__id_div_psb ?>">
           
            <?php echo h1(TX_DSPN); ?>
            <?php echo $__li_psb['tt'].ul('<div class="__ovly_w"></div>', '_cl_prm'); ?>
             ...
             <?php 
                    ...
                    $CntJV .=   "
                            ...
                            function __getJs(_v){
                                    ...
                                    function(d, status){
                                        ...
                                        if(d.e == 'ok'){
                                            ...
                                            if( d._cl_prm.total > 0 ){
                                                $.each(d._cl_prm.list, function(_k, _v) { 
                            ...
                            function __AddItm(__v){
                                ...
                                var __h = '<li id=\"'+__li_id+'\" class=\"__cl_grp_item '+ __cls_sl +' '+ _b_c +'\" rlc-id=\"'+ fnt_enc +'\">
                                            <div class=\"_add _anm '+ _b_c +'\" title=\"'+ __v.__tt +'\"  
                                                    ...
                                                    <div class=\"_opt \">
                                                        ...
                                                        <p class=\"_anm\" style=\"background-image: url(".DMN_FLE."us/_sm_'+__v.__img+')\"></p>
