...
<?php
	...
	$LsPro_Qry = "SELECT
				...
				INNER JOIN _mdl_s_tp ON id_mdlstp = mdls_tp
	...
	if($Tot_LsPro > 0){
		do {			
			$_rnd = Gn_Rnd(10);	
			if($row_LsPro['mdls_nm'] != ''){
				$__div_btns = "<input  type='button' class='__get_ls_btns' name='__get_ls_btns' id='__get_ls_btns".$_rnd."' value='".$row_LsPro["mdls_nm"]."' onclick='__chr(".$row_LsPro["id_mdls"].", ".'"'.$row_LsPro["mdls_nm"].'"'." )' > "; 
				echo $__div_btns;
			}
...
<div class="ln_1">
    ...
    <div class="col_2 __rlc_e off" id="<?php echo $__id_div_psb ?>">
            ...
            <?php echo "<h1 style='display:none;' class='h1Btns' id='h1Btns'></h1>"; ?>
			 ...
			 <?php 
					...
					$CntJV .=	"
							...
							function __getJs(_v){
									...
									if(__ss != undefined && _v._t != 'r'){ var ___ss = __ss; }else{ ___ss = ''; }	
									...
									__u.addClass('__ld');
                               		...
                               		$.post('".Fl_Rnd(FL_JSON_GN.__t('us_mdl',true))."', { sch: ___s, btns: ___ss, sds:"._SbLs_ID('i').", in:__in_e },
                                    function(d, status){
                                        ...
                                        if(d.e == 'ok'){
                                            ...
                                            if( d.mdl.total > 0 ){
	                                            $.each(d.mdl.list, function(_k, _v) { 
							...
							function __snd_upd(__v){
			                   		...
			                   		if(__v.__t == 'a'){ 
			                   			...
			                   			var _MM = 'MMR_delete'; 
			                   			var _IlI = 'Act_'+__v.__t_prc+'_'+__v.__i_sds; 
			                   			var _Uli = '{$__id_div_psb}';
			                   			var _t_go = 'a'; 
			                   		}
