...
$__lssb = _SbLs();
$__bdtp = 'ec_lsts_adm'; // Tipo de Datos
$__fmtp = 'EdEcLstsAdm'; // Nombre Formulario
					...
					$CntJV .=	"
							...
							function __getJs(_v){
									...
									__u.addClass('__ld');
                               		...
                               		$.post('".Fl_Rnd(FL_JSON_GN.__t('ec_lsts_adm',true))."', { sch: ___s, sds:"._SbLs_ID('i').", in:__in_e },
                                    function(d, status){
                                        ...
                                        if(d.e == 'ok'){
                                            ...
                                            if( d.pro.total > 0 ){
	                                            $.each(d.pro.list, function(_k, _v) { 
