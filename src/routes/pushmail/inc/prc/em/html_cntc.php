...
if ((isset($_POST["MM_Send"])) && ($_POST["MM_Send"] == "EcCntc")) { 
	$as_adm = 'Contacto a traves de Pushmail '.$__dtec->tt;
	$as_us = $___us_nm.', gracias por su mensaje';
