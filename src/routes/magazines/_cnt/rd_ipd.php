...
<link href="<?php echo DMN_DG ?>inc/sty/all_rd_ipd.php?_i=<?php echo $iD_rD ?>" rel="stylesheet" type="text/css">
  ...
  <div id='slider' class='swipe'>
    <div class='swipe-wrap'>
		<?php for ($i = 1; $i <= $row_Dt_rD['rd_pg']; $i++){ ?>
          <figure>
            <div class='wrap'>
                <div class='image' style='background:url(<?php echo DMN_RD_2_BS.DIR_RD_FL.$row_Dt_rD['rd_dir'].'/big/pag'.$i.'.jpg'; ?>) center no-repeat; background-size: cover'> </div>
            </div>
          </figure>
        <?php }; ?>   
    </div>
...
<div id="Sv_Hd">
        <div id="BtnBar"></div>
        <div id="fbMenu"><?php echo $Img_Hd_1.$Img_Hd_2 ?></div>
